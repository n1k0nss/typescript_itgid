...
const p_11: number = parseInt(document.querySelector('.p-11').textContent, 10);
console.log('Task 11:', p_11);


// Task 12
// Створіть константу p_12 і отримайте в неї число з .p-12. Константу виведіть у консоль.
const p_12: number = parseFloat(document.querySelector('.p-12').textContent);
...
let p_13: string = document.querySelector('.p-13').textContent;
if (!isNaN(Number(p_13))) {
    n_13 = Number(p_13);
} else {
    s_13 = p_13;
}
