...
let res_2;
function f02() {
    res_2 = +document.querySelector('input.i-2').value;
    console.log(res_2);
}
...
let min_4;
function f04() {
    let n_41 = +document.querySelector('input.i-41').value;
    let n_42 = +document.querySelector('input.i-42').value;
...
function f05() {
    error_5 = false;
    let n_51 = +document.querySelector('input.i-51').value;
    let n_52 = +document.querySelector('input.i-52').value;
...
let error_6;
function f06() {
    let s_61 = document.querySelector('input.i-61').value;
    let s_62 = document.querySelector('input.i-62').value;
...
let max_7;
function f07() {
    let s_71 = document.querySelector('input.i-71').value;
    let s_72 = document.querySelector('input.i-72').value;
    s_71 > s_72 ? max_7 = s_71 : max_7 = s_72;
    document.querySelector('.out-7').textContent = String(max_7);
}
...
let val_8;
function f08() {
    let val_8 = document.querySelector('select.s-8').value;
...
let val_9 = 3;
function f09() {
    let select = document.querySelector('select.s-9');
...
let res_10 = false;
function f10() {
    res_10 = document.querySelector('.ch-10').checked;
...
function f13() {
    let n_13 = +document.querySelector('input.i-13').value;
    let result = '';
...
let res_14;
function f14() {
    res_14 = +document.querySelector('input.i-14').value % 2 === 0;
...
let res_16;
function f16() {
    res_16 = document.querySelector('input.i-16').value.length;
...
let s_20 = 0;
function f20() {
    let input = document.querySelector('input.i-20');
    let inputValue = +input.value;
    s_20 = 0;
    while (inputValue != 0) {
        s_20 += inputValue;
