...
const s_031 : string = 'Hello';
const s_032 : string = ' TypeScript';
...
(document.querySelector('.out-4') as HTMLElement).textContent = String(s_04);
...
(document.querySelector('.out-5') as HTMLElement).textContent = String(s_05);
...
(document.querySelector('.out-7') as HTMLElement).textContent = String(k_07);
...
(document.querySelector('.out-8') as HTMLElement).textContent = String(res_8);
...
(document.querySelector('.out-9') as HTMLElement).textContent = String(p_09 + t_09);

//Task 10
// Отримайте у змінну p_10 (тип number) число з .p-10. Змінну виведіть у консоль.
let p_10: number = Number((document.querySelector('.p-10') as HTMLElement).textContent);
console.log('Task 10:', p_10);


// Task 11
// Створіть константу p_11 і отримайте в неї число з .p-11. Константу виведіть у консоль.
const p_11: number = parseInt((document.querySelector('.p-11') as HTMLElement).textContent, 10);
console.log('Task 11:', p_11);


// Task 12
// Створіть константу p_12 і отримайте в неї число з .p-12. Константу виведіть у консоль.
const p_12: number = parseFloat((document.querySelector('.p-12') as HTMLElement).textContent);
...
let n_13: number | undefined;
let s_13: string | undefined;
let p_13: string = (document.querySelector('.p-13') as HTMLElement).textContent;
...
(document.querySelector('.out-15') as HTMLElement).textContent = String(b_15);
...
(document.querySelector('.out-17') as HTMLElement).textContent = String(b_17);
...
let b_19: boolean = Boolean((document.querySelector('.p-19') as HTMLElement).textContent);
...
let b_20: boolean = Boolean(Number((document.querySelector('.p-20') as HTMLElement).textContent));
